...
\DoxyCodeLine{50 }
\DoxyCodeLine{51         \textcolor{keyword}{typedef} \textcolor{keyword}{struct }\_RX\_STATE}
\DoxyCodeLine{52         \{}
\DoxyCodeLine{53             \textcolor{comment}{// reception varaibles}}
\DoxyCodeLine{54             \_RX\_STATE (*state\_fptr)(uint8\_t c, \_RX\_STATE state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
...
\DoxyCodeLine{62 }
\DoxyCodeLine{63         \}sRxStruct;}
\DoxyCodeLine{64 }
\DoxyCodeLine{65         sRxStruct \_RxState;}
\DoxyCodeLine{66 }
\DoxyCodeLine{67         \textcolor{keyword}{static} sRxStruct ResetRxStruct(sRxStruct state);}
\DoxyCodeLine{68 }
\DoxyCodeLine{69         \textcolor{keyword}{static} sRxStruct RxState\_WaitForSyncSequence(uint8\_t c, sRxStruct state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
\DoxyCodeLine{70         \textcolor{keyword}{static} sRxStruct RxState\_GetProtocolVersion(uint8\_t c, sRxStruct state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
\DoxyCodeLine{71         \textcolor{keyword}{static} sRxStruct RxState\_GetPayloadLength(uint8\_t c, sRxStruct state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
\DoxyCodeLine{72         \textcolor{keyword}{static} sRxStruct RxState\_GetIdNumber(uint8\_t c, sRxStruct state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
\DoxyCodeLine{73         \textcolor{keyword}{static} sRxStruct RxState\_GetAcknowledgeId(uint8\_t c, sRxStruct state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
\DoxyCodeLine{74         \textcolor{keyword}{static} sRxStruct RxState\_GetPayloadChecksum(uint8\_t c, sRxStruct state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
\DoxyCodeLine{75         \textcolor{keyword}{static} sRxStruct RxState\_GetHeaderChecksum(uint8\_t c, sRxStruct state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
\DoxyCodeLine{76         \textcolor{keyword}{static} sRxStruct RxState\_GetPayloadAndProcessMessageContents(uint8\_t c, sRxStruct state, \mbox{\hyperlink{class_protocol_receiver}{ProtocolReceiver}} * protocolReceiver);}
\DoxyCodeLine{77 \};}
\DoxyCodeLine{78 }
